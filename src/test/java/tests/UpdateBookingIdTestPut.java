...
public class UpdateBookingIdTestPut {
    ...
    public void updateBooking() throws JsonProcessingException {
        ...
        newBooking.setDepositpaid(true);
        newBooking.setBookingdates(new BookingDates("2025-01-11","2025-11-10"));
        newBooking.setAdditionalneeds("Breakfast and Dinner");
    ...
    public void deleteId () {
        ...
        assertThat(apiClient.getBookingId(createBooking.getBookingid()).getStatusCode()).isEqualTo(404); // Проверка удаленного ID
